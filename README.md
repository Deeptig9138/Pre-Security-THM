...
The **Pre-Security** learning path is designed to teach the *pre-requisite technical knowledge* required to get started in **cyber security**.  
Before you can **attack** or **defend** any technology, it’s essential to understand **how that technology works**.

This path is **beginner-friendly**, engaging, and structured to build a strong foundation.  
Your **cyber security learning journey starts here** 🚀
